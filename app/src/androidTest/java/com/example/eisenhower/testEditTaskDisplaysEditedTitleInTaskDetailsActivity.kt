...
class testEditTaskDisplaysEditedTitleInTaskDetailsActivity {
    ...
    @Test
    fun testEditTaskDisplaysEditedTitleInTaskDetailsActivity() {
        ...
        val textView = onView(
            withIndex(
                allOf(
                    withId(R.id.taskTitleTextView), withText("edited title"),
